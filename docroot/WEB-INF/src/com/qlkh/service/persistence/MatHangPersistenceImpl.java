...
import com.qlkh.NoSuchMatHangException;

import com.qlkh.model.MatHang;
import com.qlkh.model.impl.MatHangImpl;
import com.qlkh.model.impl.MatHangModelImpl;
...
public class MatHangPersistenceImpl extends BasePersistenceImpl<MatHang>
	 ...
	 */
	@Override
	public MatHang create(String MaHang) {
		MatHang matHang = new MatHangImpl();

		matHang.setNew(true);
		matHang.setPrimaryKey(MaHang);
	 ...
	 */
	@Override
	public MatHang remove(String MaHang)
		throws NoSuchMatHangException, SystemException {
		return remove((Serializable)MaHang);
	}
	...
	@Override
	public MatHang updateImpl(com.qlkh.model.MatHang matHang)
	...
	protected MatHang toUnwrappedModel(MatHang matHang) {
		...
		matHangImpl.setMaHang(matHang.getMaHang());
		matHangImpl.setTenHang(matHang.getTenHang());
		matHangImpl.setGiaThanh(matHang.getGiaThanh());
	 ...
	 */
	@Override
	public MatHang findByPrimaryKey(String MaHang)
		throws NoSuchMatHangException, SystemException {
		return findByPrimaryKey((Serializable)MaHang);
	}
	 ...
	 */
	@Override
	public MatHang fetchByPrimaryKey(String MaHang) throws SystemException {
		return fetchByPrimaryKey((Serializable)MaHang);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.qlkh.model.MatHang")));
