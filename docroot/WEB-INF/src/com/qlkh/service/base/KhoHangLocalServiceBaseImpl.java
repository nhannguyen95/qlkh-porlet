...
import com.qlkh.service.KhoHangLocalService;
...
/**
 * Provides the base implementation for the kho hang local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.qlkh.service.impl.KhoHangLocalServiceImpl}.
 * </p>
 *
 * @author apple
 ...
 * @generated
 */
public abstract class KhoHangLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements KhoHangLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.qlkh.service.KhoHangLocalServiceUtil} to access the kho hang local service.
	 */
	...
	@Override
	public KhoHang addKhoHang(KhoHang khoHang) throws SystemException {
		khoHang.setNew(true);

		return khoHangPersistence.update(khoHang);
	}
	 ...
	 */
	@Override
	public KhoHang createKhoHang(String MaKho) {
		return khoHangPersistence.create(MaKho);
	}
	...
	@Override
	public KhoHang deleteKhoHang(String MaKho)
		throws PortalException, SystemException {
		return khoHangPersistence.remove(MaKho);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public KhoHang deleteKhoHang(KhoHang khoHang) throws SystemException {
		return khoHangPersistence.remove(khoHang);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(KhoHang.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return khoHangPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return khoHangPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return khoHangPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return khoHangPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return khoHangPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public KhoHang fetchKhoHang(String MaKho) throws SystemException {
		return khoHangPersistence.fetchByPrimaryKey(MaKho);
	}
	 ...
	 */
	@Override
	public KhoHang getKhoHang(String MaKho)
		throws PortalException, SystemException {
		return khoHangPersistence.findByPrimaryKey(MaKho);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return khoHangPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<KhoHang> getKhoHangs(int start, int end)
		throws SystemException {
		return khoHangPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getKhoHangsCount() throws SystemException {
		return khoHangPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public KhoHang updateKhoHang(KhoHang khoHang) throws SystemException {
		return khoHangPersistence.update(khoHang);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.qlkh.model.KhoHang",
			khoHangLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.qlkh.model.KhoHang");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = khoHangPersistence.getDataSource();
	...
	private KhoHangLocalServiceClpInvoker _clpInvoker = new KhoHangLocalServiceClpInvoker();
}