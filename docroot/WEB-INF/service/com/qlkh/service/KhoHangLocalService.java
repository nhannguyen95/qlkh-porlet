...
/**
 * Provides the local service interface for KhoHang. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author apple
 * @see KhoHangLocalServiceUtil
...
public interface KhoHangLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link KhoHangLocalServiceUtil} to access the kho hang local service. Add custom service methods to {@link com.qlkh.service.impl.KhoHangLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
